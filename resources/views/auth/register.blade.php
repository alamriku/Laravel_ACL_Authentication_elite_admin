...
<section id="wrapper">
    <div class="login-register" style="background-image:url({{asset('public')}}/assets/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{route('sign-up')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        @error('name')
                        <span class="invalid-feedback" role="alert" style="  @error('name')  display:block  @enderror">
                    ...
                    <div class="form-group ">
                        ...
                        @error('email')
                        <span class="invalid-feedback" role="alert" style="  @error('email')  display:block  @enderror">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        @enderror
                    </div>
                    <div class="form-group ">
                        ...
                        @error('password')
                        <span class="invalid-feedback" role="alert" style="  @error('password')  display:block  @enderror">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <span class="invalid-feedback" role="alert" style="  @error('password_confirmation')  display:block  @enderror">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        @enderror
                    </div>
